...
func (c *aiWrapperServiceClient) BuildTransactionFromText(ctx context.Context, in *BuildTransactionFromTextRequest, opts ...grpc.CallOption) (*TransactionResponseV2, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TransactionResponseV2)
...
func (c *aiWrapperServiceClient) BuildTransactionFromImage(ctx context.Context, in *BuildTransactionFromImageRequest, opts ...grpc.CallOption) (*TransactionResponseV2, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TransactionResponseV2)
...
func (UnimplementedAiWrapperServiceServer) BuildTransactionFromText(context.Context, *BuildTransactionFromTextRequest) (*TransactionResponseV2, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BuildTransactionFromText not implemented")
}
func (UnimplementedAiWrapperServiceServer) BuildTransactionFromImage(context.Context, *BuildTransactionFromImageRequest) (*TransactionResponseV2, error) {
